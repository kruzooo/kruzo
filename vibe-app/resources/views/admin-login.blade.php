        ...
        <section class="admin-login-wrap">
            ...
            <section class="admin-login-card">
                ...
                <form method="POST" action="{{ route('admin.login.authenticate') }}" class="admin-login-form">
                    @csrf
                    <label>OPERATOR IDENTITY <small>ID OR REGISTERED EMAIL</small><div><span class="material-symbols-outlined">badge</span><input name="operator_id" type="email" value="{{ old('operator_id') }}" autocomplete="username" placeholder="admin@your-domain.com" required autofocus></div></label>
